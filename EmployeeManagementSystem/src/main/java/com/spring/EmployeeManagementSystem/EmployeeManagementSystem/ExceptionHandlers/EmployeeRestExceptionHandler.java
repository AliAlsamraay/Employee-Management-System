...
public class EmployeeRestExceptionHandler {
    ...
    public ResponseEntity<EmployeeErrorResponse> handleEmployeeNotFoundException(
        ...
        final EmployeeErrorResponse error = new EmployeeErrorResponse(HttpStatus.NOT_FOUND.value(), ex.getMessage(),
    ...
    public ResponseEntity<EmployeeErrorResponse> handleRuntimeException(RuntimeException ex) {
        final EmployeeErrorResponse error = new EmployeeErrorResponse(HttpStatus.BAD_REQUEST.value(), ex.getMessage(),
                System.currentTimeMillis());
